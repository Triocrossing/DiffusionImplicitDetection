...
class CoLaDDeModule(LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.criterion_triplet = torch.nn.TripletMarginLoss(margin=5.0, p=2, eps=1e-7)
    ...
    def model_step(
        ...
        loss_contras = self.criterion_triplet(
            feat_anchor,
            feat_anchor[perm],
            feat_negative,
        )
    ...
    def training_step(
        ...
        """
        loss_contras, loss_cls, logits, preds, y, _, _ = self.model_step(batch)
        loss = (
